  ...
  return (
    <section id="reviews-section" className="relative py-[100px] md:py-[140px] bg-bg-primary border-b border-border-main z-10 select-none overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          {reviews.length === 0 ? (
            <div className="col-span-full py-16 text-center text-text-secondary/60 font-mono-code text-[11px] uppercase tracking-widest border border-dashed border-border-main/60 rounded-[16px]">
              No client audits or reviews published yet.
            </div>
          ) : (
